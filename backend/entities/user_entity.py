...
class UserEntity(EntityBase):
    ...
    # Coworking status toggle
    is_coworking: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    ...
    def from_model(cls, model: User) -> Self:
        ...
        return cls(
            ...
            is_coworking=model.is_coworking,
        )
    ...
    def to_model(self) -> User:
        ...
        return User(
            ...
            is_coworking=self.is_coworking,
        )
    ...
    def update(self, model: User) -> None:
        ...
        self.is_coworking = model.is_coworking
